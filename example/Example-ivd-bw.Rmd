...
plot(1-sp, se, type = "p", ylim = c(0,1), xlim = c(0,1), 
     xlab = "1-specificity", ylab = "Sensitivity", col="grey50")
SROC.matrix(est2[c(1:5),  ], add = TRUE, ncols = cols, sroc.lty = ltys, spoint.pch = pchs)
legend("bottomright", 
       bty='n',
       legend = c(sprintf("p = %.1f, SAUC = %.3f", p.seq, est2[10, ])), 
       col = cols, pch = pchs, pt.cex = 2, cex = 1.2, 
       lty = ltys)
...
plot(1-sp, se, type = "p", ylim = c(0,1), xlim = c(0,1), 
     xlab = "1-specificity", ylab = "Sensitivity", col="grey50")
SROC.matrix(est11[c(1:5),  ], add = TRUE, ncols = cols, sroc.lty = ltys, spoint.pch = pchs)
legend("bottomright", 
       bty='n',
       legend = c(sprintf("p = %.1f, SAUC = %.3f", p.seq, est2[10, ])), 
       col = cols, pch = pchs, pt.cex = 2, cex = 1.2, 
...
plot(1-sp, se, type = "p", ylim = c(0,1), xlim = c(0,1), 
     xlab = "1-specificity", ylab = "Sensitivity", col="grey50")
SROC.matrix(est10[c(1:5),  ], add = TRUE, ncols = cols, sroc.lty = ltys, spoint.pch = pchs)
legend("bottomright", 
       bty='n',
       legend = c(sprintf("p = %.1f, SAUC = %.3f", p.seq, est2[10, ])), 
       col = cols, pch = pchs, pt.cex = 2, cex = 1.2, 
...
plot(1-sp, se, type = "p", ylim = c(0,1), xlim = c(0,1), 
     xlab = "1-specificity", ylab = "Sensitivity", col="grey50")
SROC.matrix(est01[c(1:5),  ], add = TRUE, ncols = cols, sroc.lty = ltys, spoint.pch = pchs)
legend("bottomright", 
       bty='n',
       legend = c(sprintf("p = %.1f, SAUC = %.3f", p.seq, est2[10, ])), 
       col = cols, pch = pchs, pt.cex = 2, cex = 1.2, 
...
cols <- c(1, "grey50", "grey70")
  
par(mfrow = c(2, 2))
curve(pnorm(est2[8,2]*x + est2[9,2]), -5, 15, ylim = c(0,1),
      xlab = ("t"), ylab = TeX("$p = \\Phi(\\beta \\, t + \\alpha)$"), col=cols[1],
      yaxt='n')
axis(2, at=c(0,0.5,1), labels = c(0,0.5,1))
curve(pnorm(est2[8,3]*x + est2[9,3]), -5, 15, add = TRUE, col=cols[2])
curve(pnorm(est2[8,4]*x + est2[9,4]), -5, 15, add = TRUE, col=cols[3])
...
points(t02, rep(0.2, 33), pch="|", col=cols[1], cex=0.7)
points(t03, rep(0.1, 33), pch="|", col=cols[2], cex=0.7)
points(t04, rep(0, 33),   pch="|", col=cols[3], cex=0.7)
title(TeX("$(\\hat{c}_1, \\, \\hat{c}_2)$"), cex.main = 1.5)
legend("topright", 
       bty='n',
...
curve(pnorm(est11[8,2]*x + est11[9,2]), -5, 15,ylim = c(0,1),
      ...
      yaxt='n')
axis(2, at=c(0,0.5,1), labels = c(0,0.5,1))
curve(pnorm(est11[8,3]*x + est11[9,3]), -5, 15, add = TRUE, col=cols[2])
curve(pnorm(est11[8,4]*x + est11[9,4]), -5, 15, add = TRUE, col=cols[3])
...
curve(pnorm(est10[8,2]*x + est10[9,2]), -5, 15,ylim = c(0,1),
      ...
      yaxt='n')
axis(2, at=c(0,0.5,1), labels = c(0,0.5,1))
curve(pnorm(est10[8,3]*x + est10[9,3]), -5, 15, add = TRUE, col=cols[2])
curve(pnorm(est10[8,4]*x + est10[9,4]), -5, 15, add = TRUE, col=cols[3])
...
curve(pnorm(est01[8,2]*x + est01[9,2]), -5, 15, ylim = c(0,1),
      ...
      yaxt='n')
axis(2, at=c(0,0.5,1), labels = c(0,0.5,1))
curve(pnorm(est01[8,3]*x + est01[9,3]), -5, 15, add = TRUE, col=cols[2])
curve(pnorm(est01[8,4]*x + est01[9,4]), -5, 15, add = TRUE, col=cols[3])
...
matplot(t(est2),ylim=c(0,1), type = "b",lty = c(1,2,2), pch=20, col = cols,
...
matplot(t(est11),ylim=c(0,1), type = "b",lty = c(1,2,2), pch=20, col = cols,
         ylab = "SAUC", xlab = "p", xaxt = "n")
title(TeX("$c_1 = c_2$"), cex.main = 1.5)
axis(1, at = 1:10, labels = p.seq)
...
matplot(t(est10),ylim=c(0,1), type = "b",lty = c(1,2,2), pch=20, col = cols,
         ylab = "SAUC", xlab = "p", xaxt = "n")
title(TeX("$(c_1, \\,c_2) = (1, \\,0)$"), cex.main = 1.5)
axis(1, at = 1:10, labels = p.seq)
# title("(a)", adj = 0, font.main = 1)
...
matplot(t(est01),ylim=c(0,1), type = "b",lty = c(1,2,2), pch=20, col = cols,
         ylab = "SAUC", xlab = "p", xaxt = "n")
title(TeX("$(c_1, \\,c_2) = (0, \\,1)$"), cex.main = 1.5)
axis(1, at = 1:10, labels = p.seq)
# title("(b)", adj = 0, font.main = 1)
