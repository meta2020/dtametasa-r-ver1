---
title: "Appendix Table: estimates of other parameters when c11 = c22"
subtitle: "Scenario 9, 10, 15, 16"
author: "Yi"
...
table.pars <- function(list.n, row.n){
  ...
  X <- cbind.data.frame(true.par, 
                        ...
                        med.sa1 = sprintf("%.2f [%.2f, %.2f]", med[,2], iq25[,2], iq75[,2]),
                        med.BRE = sprintf("%.2f [%.2f, %.2f]", med[,3], iq25[,3], iq75[,3]),
                       med.BRE.p= sprintf("%.2f [%.2f, %.2f]", med[,4], iq25[,4], iq75[,4]) )
