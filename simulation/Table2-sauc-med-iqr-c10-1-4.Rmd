---
title: "Main text Table 2"
subtitle: "Estimates of SAUC with CR when $c_1^2 =1,  c_2^2=0$ for scenario 1-4"
author: "Yi"
...
longtab.f <- cbind.data.frame(" " = rep(c("Proposed $(\\hat{c}_1^2, \\hat{c}_2^2)$",
                                          "Proposed $(c_1^2=1)$",
...
colnames(longtab.f)[2:8] <- c("SAUC", rep(c("Median (Q1, Q3)", "CR"), 3))
...
kbl(longtab.f, 
  ...
  footnote(general = "Proposed $({\\hat{c}_1^2, \\hat{c}_2^2})$ is the proposed model estimating $(c_1^2, c_2^2)^T$;
Proposed $({\\hat{c}_1^2, \\hat{c}_2^2})$ is the proposed model specified $c_1^2=c_2^2 =0.5$;
